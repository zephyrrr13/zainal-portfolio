    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-white/10 pb-6">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-xl border border-white bg-white px-4 py-2.5 font-mono text-xs font-bold uppercase text-black hover:bg-zinc-200 transition-colors shadow-lg"
        >
      ...
      {notification && (
        <div className="flex items-center gap-3 rounded-xl border border-emerald-500/30 bg-emerald-950/40 p-4 font-mono text-xs text-emerald-300">
      ...
      <div className="overflow-hidden rounded-3xl border border-white/10 bg-zinc-950/80 shadow-xl backdrop-blur-xl">
        <div className="p-5 border-b border-white/10 font-mono text-xs text-zinc-400 flex items-center justify-between">
          ...
          {articles.map((art) => (
            ...
            >
              <div className="flex items-start gap-4 min-w-0">
                <div className="hidden sm:flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-zinc-900 border border-white/10 font-mono text-xs text-zinc-400">
                ...
                <div className="min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    {art.published ? (
                      ...
                      <span className="font-mono text-[10px] text-zinc-500">Draft</span>
                    )}
                  </div>
                  ...
                  <p className="line-clamp-1 font-mono text-xs text-zinc-400 mt-0.5">
                    {art.excerpt || "Tidak ada deskripsi singkat."}
                  </p>

                  <div className="flex items-center gap-4 mt-2 font-mono text-[11px] text-zinc-500">
              ...
              <div className="flex items-center gap-2 self-end sm:self-center">
                <button
                  ...
                  className="flex items-center gap-1.5 rounded-lg border border-white/15 bg-zinc-900 px-3 py-1.5 font-mono text-xs text-zinc-300 hover:bg-white/10 hover:text-white transition-colors"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 rounded-lg border border-red-500/20 bg-red-950/20 px-3 py-1.5 font-mono text-xs text-red-400 hover:bg-red-900/40 transition-colors"
                >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4 overflow-y-auto">
          <div className="relative w-full max-w-3xl rounded-3xl border border-white/20 bg-zinc-950 p-6 md:p-8 shadow-2xl my-8">
            ...
            <form onSubmit={handleSave} className="space-y-4">
              <div>
                <label className="mb-1 block font-mono text-[11px] uppercase tracking-wider text-zinc-300">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-xl border border-white/15 bg-zinc-900 px-4 py-2.5 pl-10 font-mono text-xs text-white focus:border-white focus:outline-none"
                    />
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full rounded-xl border border-white/15 bg-zinc-900 p-3 font-mono text-xs text-white focus:border-white focus:outline-none"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full rounded-xl border border-white/15 bg-zinc-900 p-3 font-mono text-xs text-white focus:border-white focus:outline-none font-mono"
                />
              </div>
              ...
              <div className="flex items-center justify-between pt-4 border-t border-white/10">
                ...
                <div className="flex items-center gap-3">
                  <button
                    type="button"
                    onClick={() => setIsEditing(false)}
                    className="rounded-xl border border-white/15 px-4 py-2.5 font-mono text-xs text-zinc-400 hover:text-white"
                  >
                    Batal
                  </button>
                  <button
                    ...
                    className="flex items-center gap-2 rounded-xl border border-white bg-white px-5 py-2.5 font-mono text-xs font-bold uppercase text-black hover:bg-zinc-200"
                  >
