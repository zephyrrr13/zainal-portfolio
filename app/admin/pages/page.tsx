...
export default function AdminPagesEditor() {
  ...
  if (loading || !settings) {
    return (
      <div className="flex min-h-[400px] items-center justify-center font-mono text-xs text-zinc-500">
    ...
    <div className="space-y-6 max-w-4xl">
      <div className="flex items-center justify-between border-b border-white/10 pb-6">
        ...
        <button
          onClick={handleSave}
          disabled={saving}
          className="flex items-center gap-2 rounded-xl border border-white bg-white px-5 py-2.5 font-mono text-xs font-bold uppercase text-black hover:bg-zinc-200 transition-colors shadow-lg disabled:opacity-60"
        >
      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <div className="rounded-3xl border border-white/10 bg-zinc-950/80 p-6 md:p-8 backdrop-blur-xl">
          <div className="flex items-center gap-2 font-mono text-xs text-zinc-300 mb-6 border-b border-white/10 pb-4">
            ...
            <span className="font-bold">1. HERO SECTION & IDENTITAS</span>
          </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-white/15 bg-zinc-900 px-4 py-2.5 font-mono text-xs text-white focus:border-white focus:outline-none"
              />
            </div>
        ...
        <div className="rounded-3xl border border-white/10 bg-zinc-950/80 p-6 md:p-8 backdrop-blur-xl">
          <div className="flex items-center gap-2 font-mono text-xs text-zinc-300 mb-6 border-b border-white/10 pb-4">
            ...
            <span className="font-bold">2. ABOUT ME & NARASI PROFIL</span>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full rounded-xl border border-white/15 bg-zinc-900 p-4 font-mono text-xs text-white focus:border-white focus:outline-none leading-relaxed"
            />
          </div>
        </div>
        ...
        <div className="rounded-3xl border border-white/10 bg-zinc-950/80 p-6 md:p-8 backdrop-blur-xl">
          <div className="flex items-center gap-2 font-mono text-xs text-zinc-300 mb-6 border-b border-white/10 pb-4">
            ...
            <span className="font-bold">3. KONTAK & LINK SOSIAL MEDIA</span>
          </div>
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            disabled={saving}
            className="flex items-center gap-2 rounded-xl border border-white bg-white px-6 py-3 font-mono text-xs font-bold uppercase text-black hover:bg-zinc-200 transition-colors shadow-lg"
          >
            <Save className="h-4 w-4" />
